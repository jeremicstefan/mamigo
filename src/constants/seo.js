...
export const LOCAL_BUSINESS_SCHEMA = {
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      ...
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Čišćenje hotela i smeštajnih objekata' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Čišćenje restorana i ugostiteljskih objekata' } },
